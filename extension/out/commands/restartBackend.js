...
exports.restartBackendCommand = restartBackendCommand;
const vscode = __importStar(require("vscode"));
function restartBackendCommand(context) {
    ...
    vscode.window.showInformationMessage('🔄 ShepThon backend will restart here', 'Coming Soon');
 ...
 * - Log endpoint calls
 */
//# sourceMappingURL=restartBackend.js.map