...
![ShepLang Icon](https://github.com/Radix-Obsidian/Sheplang-BobaScript/raw/HEAD/media/icon.png)
...
- Read the [full tutorial](https://github.com/Radix-Obsidian/Sheplang-BobaScript/blob/HEAD/link-to-docs)
- Join the community!
