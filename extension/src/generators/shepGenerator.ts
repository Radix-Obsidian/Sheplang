 ...
 */
export function generateShepLangFiles(appModel: AppModel): GeneratedFile[] {
 ...
 */
function generateMainShepFile(appModel: AppModel): string {
  let output = '';
 ...
 */
function generateDataBlock(entity: Entity): string {
  let output = '';
 ...
 * Generate view block
 */
function generateViewBlock(view: View, entities: Entity[]): string {
  let output = '';
 ...
 */
function generateActionBlock(action: Action, entities: Entity[]): string {
  let output = '';
 ...
 */
function inferVariableFromPath(path: string): string {
 ...
 */
function getReloadPath(path: string): string {
 ...
 */
function inferTargetView(actionName: string, entities: Entity[]): string {
 ...
 */
function createDashboardView(appModel: AppModel): View {
 ...
 */
export function generateImportReport(appModel: AppModel, files: GeneratedFile[]): string {
  let report = '';
