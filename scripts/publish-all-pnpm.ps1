# Publish all ShepLang packages to npm using PNPM
# This correctly replaces workspace:* with actual versions
# Must be run from project root

Write-Host "🚀 Publishing ShepLang packages to @goldensheepai using PNPM..." -ForegroundColor Green
...
# Publish in dependency order using PNPM (not npm!)
Write-Host ""
Write-Host "📤 Publishing packages with PNPM (workspace:* will be auto-replaced)..." -ForegroundColor Yellow
Write-Host ""
...
Write-Host "   npm install -g @goldensheepai/sheplang" -ForegroundColor Cyan
Write-Host "   npx @goldensheepai/sheplang --version" -ForegroundColor Cyan
